...
#define	SAVE_1_MINUTE	// 1�и��� ����, else 3�и��� ����(�׽�Ʈ�ʿ�)
										 
//#define SAVE_SECOND	// �ʴ��� ������(60��) ����,  else 1�е�����(1��) ����
...
typedef struct{                   //Menu->Config->Analog Value        �Ƴ��α� �Է� ������
...
typedef struct{                   //Menu->Config->Communication Value  ���? ���� �Է� ������
	...
	uint16_t modbusSensor1Addr;//RS485 pH����(1��) Slave ID, 1~247, �⺻ 2
	uint16_t modbusSensor2Addr;//RS485 EC����(2��) Slave ID, 1~247, �⺻ 4
}ComSetupValue;
...
typedef struct{                    //Menu->Calibration Value
	...
	int32_t EC_Span_Cal;//Range 999      // �ڵ�����
	int32_t EC_Span_Value;//Range 999      // �ڵ�����


	// �µ� 
	int16_t TEMP_Span_Cal1;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Value1;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Cal2;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Value2;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Cal3;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Value3;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Cal4;//Range 999      // �ڵ�����
	int16_t TEMP_Span_Value4;//Range 999      // �ڵ�����
