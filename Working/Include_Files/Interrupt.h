...
extern uint16_t rx1Buffer[32];
extern uint16_t rx2Buffer[32];
extern uint16_t rx3Buffer[32];
extern uint16_t tx1Buffer[15];
extern uint16_t tx2Buffer[32];
extern uint16_t tx3Buffer[32];
extern uint16_t tx1Size, tx1Count, rx1Size;
extern uint16_t tx2Size, tx2Count, rx2Size;
extern uint16_t tx3Size, tx3Count, rx3Size;
extern char com485State;
